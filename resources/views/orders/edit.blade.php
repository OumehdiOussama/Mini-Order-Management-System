...
@section("content")
    <div class="max-w-2xl mx-auto">
        <div class="p-8 bg-white rounded-lg shadow-md">
            <h1 class="mb-6 text-2xl font-bold text-gray-800">Update Order #{{ $order->id }}</h1>
            ...
            <form action="{{ route("orders.update", $order) }}" method="POST">
                ...
                <div class="p-4 mb-6 border border-gray-200 rounded bg-gray-50">
                    <h3 class="mb-2 font-semibold">Order Information</h3>
                ...
                <!-- Status Update -->
                <div class="mb-6">
                    <label class="block mb-2 text-sm font-semibold text-gray-700">New Status *</label>
                ...
                <!-- Notes -->
                <div class="mb-6">
                    <label class="block mb-2 text-sm font-semibold text-gray-700">Notes (Optional)</label>
                ...
                <div id="shippingInfo" class="p-4 mb-6 border border-blue-200 rounded bg-blue-50" style="display: {{ $selectedStatus === "shipped" ? "block" : "none" }};">
                    <h3 class="mb-3 font-semibold text-blue-900">Shipping Information</h3>
                    
                    <div class="mb-4">
                        <label class="block mb-2 text-sm font-semibold text-gray-700">Tracking Number <span class="text-red-500">*</span></label>
                    ...
                    <div>
                        <label class="block mb-2 text-sm font-semibold text-gray-700">Carrier <span class="text-red-500">*</span></label>
                ...
                <div class="flex gap-2">
                    <button type="submit" class="flex-1 px-4 py-2 font-semibold text-white bg-blue-600 rounded hover:bg-blue-700">Update Order Status</button>
                    <a href="{{ route("orders.show", $order) }}" class="flex-1 px-4 py-2 font-semibold text-center text-white bg-gray-600 rounded hover:bg-gray-700">Cancel</a>
                </div>
            </form>
